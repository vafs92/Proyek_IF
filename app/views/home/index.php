...
<head>
  ...
  <div class="container d-flex justify-content-center justify-content-md-between">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        <h1 style color>Sistem Informasi Peminjaman Barang & Ruang</h1>
        <!-- <a href="index.html"><img src="assets/img/logo.png" alt="" class="img-fluid"></a>-->
      </div>
    </div>
    <div id="topbar" class="fixed-down d-flex align-items-center">
      <div class="social-links d-none d-md-flex">
          <a href="https://www.usd.ac.id/fakultas/sainsdanteknologi/" class="facebook"><i class="bi bi-globe"></i></a>
          <a href="https://www.instagram.com/bemfst_usd/" class="instagram"><i class="bi bi-instagram"></i></a>
          ...
          <div class="carousel-item active" style="background-image: url(<?= BASEURL; ?>/img/HomeUP.jpg);">
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate_animated animate_fadeInDown">Selamat Datang di <span>SIP</span></h2>
              </div>
            </div>
          </div>

          <!-- Slide 2 -->
          <div class="carousel-item" style="background-image: url(<?= BASEURL; ?>/img/gedungFST.jpg);">
            <div class="carousel-container">
              <div class="carousel-content">
  ...
  <footer id="footer">
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>Kelompok_1</span></strong>
      </div>
      <!-- <div class="credits">
        Home Designed by <a href="https://bootstrapmade.com/">Bootstrap</a>
      </div> -->
    </div>
  </footer><!-- End Footer -->

                    ...
                    <tbody>
                        <?php foreach ($data['ruang'] as $ruang) : ?>
                            <tr>
                                <td><?= $ruang['kodeR'] ?></td>
                                <td><?= $ruang['namaR'] ?></td>
                                <td><a href="<?= BASEURL; ?>/perekaman/editR/<?= $ruang['kodeR']; ?>" class="btn btn-warning ms-1 tampilModalUbahR" style="color:black" data-bs-toggle="modal" data-bs-target="#formModal" data-id="<?= $ruang['kodeR']; ?>">edit</a>
						        <a href="<?= BASEURL; ?>/perekaman/hapusR/<?= $ruang['kodeR']; ?>" class="btn btn-danger ms-1" style="color:black" onclick="return confirm('yakin?')">hapus</a></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
